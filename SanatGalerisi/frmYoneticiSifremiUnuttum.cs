...
{
    public partial class frmYoneticiSifremiUnuttum : Form
    {
        public frmYoneticiSifremiUnuttum()
        {
            InitializeComponent();
        }
        ...
        private void btnGorevliGiris_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                frmYoneticiKodDogrulama yoneticiKodDogrulama = new frmYoneticiKodDogrulama();
                yoneticiKodDogrulama.kod = gonderilecek_kod;
                yoneticiKodDogrulama.Show();
                this.Hide();
            }
        }
    }
